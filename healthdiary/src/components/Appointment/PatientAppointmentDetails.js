...
import Navbar from '../FindADoctor/Navbar'
...
function PatientAppointmentDetails({history}) {
        ...
        <div className="doc-card">
            <Card style={{ width: '18rem' }}>
                ...
                <Card.Body>
                    ...
                    <Button className='appdet-btn' variant="primary" value = {appointment.doctor._id} onClick = {handleChange}>View Profile</Button>
                </Card.Body>
            </Card> 
            ...
            <Card.Body>
                ...
                <Card.Text className="appdet-div">
                 <div className="appdet-para">Appointment Confirmed : </div><p>{appointment.confirmed.status ? (<p>Yes</p>) : (<p> No</p>)}</p>
                </Card.Text>
                 <Card.Text className="appdet-div">
                 <div>
                ...
                <label for="appointmentTime" className="form__label">Appointment Time Slot</label>
                 ...
                 <Card.Text className="appdet-div">
                 <div className="appdet-para">Appointment Completed : </div><p>{appointment.completed.status ? (<p>Yes</p>) : (<p> No</p>)}</p>
                 
                </Card.Text>
                <Button className='appdet-btn' variant="primary" value = {appointment.doctor._id} onClick = {handleClickLiveChat}>Start Live Chat</Button>
                </div>
            </Card.Body>    
            </Card>
            ...
            <Button className='appdet-btn' variant="primary" value = {appointment._id} >Generate Prescription</Button>
        </div>
        </>
    )
}
