...
import DocNavbar from '../Dashboard/Doctor_Dashboard/DocNavbar'
        ...
        <div className="doc-card">
            <Card style={{ width: '18rem' }}>
                ...
                <Card.Body>
                    ...
                    <Card.Text className='c_text'>{appointment.doctor.email}</Card.Text>
            ...
            <Card style={{ width: '18rem' }}>
                ...
                <Card.Body>
                    ...
                    <Card.Text className='c_text'>{appointment.patient.email}</Card.Text>
                </Card.Body>
            </Card> 
            </div>
